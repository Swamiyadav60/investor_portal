...
const investorNav: NavItem[] = [
  ...
  { to: '/waitlist', label: 'My Waitlist', icon: <svg viewBox="0 0 24 24"><line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="21" y2="18"/><line x1="3" y1="6" x2="3.01" y2="6"/><line x1="3" y1="12" x2="3.01" y2="12"/><line x1="3" y1="18" x2="3.01" y2="18"/></svg> },
...
const adminNav: NavItem[] = [
  ...
  { to: '/admin/installations', label: 'Installations', icon: <svg viewBox="0 0 24 24"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg> },
  ...
  { to: '/admin/expense-catalog', label: 'Expense Catalog', icon: <svg viewBox="0 0 24 24"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/><circle cx="9" cy="8" r="1"/><circle cx="9" cy="12" r="1"/><circle cx="9" cy="16" r="1"/><line x1="13" y1="8" x2="17" y2="8"/><line x1="13" y1="12" x2="17" y2="12"/><line x1="13" y1="16" x2="17" y2="16"/></svg> },
...
const ambassadorNav: NavItem[] = [
  { to: '/branch/dashboard', label: 'Dashboard', icon: <svg viewBox="0 0 24 24"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></svg> },
  { to: '/branch/printers', label: 'Printers', icon: <svg viewBox="0 0 24 24"><polyline points="6 9 6 2 18 2 18 9"/><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"/><rect x="6" y="14" width="12" height="8"/></svg> },
  { to: '/branch/log-expense', label: 'Log Expense', icon: <svg viewBox="0 0 24 24"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg> },
  { to: '/branch/my-expenses', label: 'My Expenses', icon: <svg viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg> },
  { to: '/branch/history', label: 'Expense History', icon: <svg viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg> },
]

export function Sidebar({ admin = false }: { admin?: boolean }) {
  const { investor, isAdmin, isAmbassador, signOut } = useAuth()
  const navigate = useNavigate()
  
  let nav = investorNav
  if (admin) nav = adminNav
  else if (isAmbassador) nav = ambassadorNav
    ...
    <aside className={`sidebar ${menuOpen ? 'open' : ''}`}>
      ...
      <Link to="/" className="sidebar-logo" title="Back to Home" style={{ cursor: 'pointer' }}>
        ...
        <div>
          ...
          <div className="sidebar-logo-sub">
            {admin ? 'Admin Portal' : isAmbassador ? 'Ambassador Portal' : 'Investor Portal'}
          </div>
        </div>
      </Link>
      ...
      <nav className="sidebar-nav">
        ...
        {admin ? (
          ...
          <NavLink to="/branch/dashboard" className="nav-item" style={{ visibility: 'hidden' }} />
        ) : null}
      </nav>
